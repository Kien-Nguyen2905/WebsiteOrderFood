...
import ecom.Repositories.FoodRepository;
...
public class FoodService implements FoodServiceImp {
    ...
    public void deleteFood(int foodId) throws Exception {
        FoodModel food = findFoodById(foodId);
    ...
    @Override
    public FoodModel findFoodById(int id) throws Exception {
        Optional<FoodModel> optionalFood= foodRepository.findById(id);
